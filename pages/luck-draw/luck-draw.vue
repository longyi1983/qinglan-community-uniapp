<template>
	<view class="luckly-wheel-container">
		<view class="header">
			<image :src="$IMG+'/images/luck-back.png'"></image>
		</view>
		<view class="main">
			<view class="row-end">
				<navigator class="user-prize row-center" url="/pages/luck-draw/prize-record" hover-class="none">
				...
				<view class="wheel-container">
					<view class="row-center">
						<view class="notice-container row">
							<image :src="$IMG+'/images/icon_notice.png'" class="icon"></image>
					...
					<view class="wheel">
						<my-lottery :lotteryData="lists" :status="status" :luckyOrder="3" :circleTimes="30"
		...
		<u-popup v-model="showResult" mode="center">
			<view class="result-popup column-center">
				...
				<view style="margin-top: 50rpx" @tap="onClose">
					<image :src="$IMG+'/images/icon_close.png'" style="width: 62rpx;height: 62rpx;"></image>
				</view>
			</view>
		</u-popup>
	</view>
